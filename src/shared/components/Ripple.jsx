import th from './Ripple.sass'
import React, { Component, PropTypes } from 'react'
import ReactDOM from 'react-dom'
import classnames from 'classnames'
import update from 'immutability-helper'
import events from 'shared/lib/utils/events'
import { removeObjectKey } from 'shared/lib/utils'
  ...
  return ComposedComponent => {
    class RippledComponent extends Component {
      ...
      addRippleRemoveEventListener (rippleKey) {
        ...
        events.addEventListenerOnTransitionEnded(this.refs[rippleKey], function onOpacityEnd (e) {
          if (e.propertyName === 'opacity') {
            ...
            self.setState({ ripples: removeObjectKey(rippleKey, self.state.ripples) })
          }
        })
      }
      ...
      renderRipple (key, className, { active, left, restarting, top, width }) {
        ...
        const _className = classnames(th.ripple, {
          [th.rippleActive]: active,
