  ...
  render () {
    ...
    return (
      <ul className='nav-tabs'>
        ...
        <NavTabLink text='Save/Share' mode={MODES.share} currentMode={mode} setMode={setMode}/>
        <NavTabLink text='Your saved filters' mode={MODES.share} currentMode={mode} setMode={setMode}/>
        <NavTabLink text='Options' mode={MODES.share} currentMode={mode} setMode={setMode}/>
